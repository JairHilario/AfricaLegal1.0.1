...
function RelClientesStatus({ onAddRelatorio, temaAtual = "dark" }) {
  ...
  const inputWrapper = "relative w-full md:w-64";
  ...
  const searchIcon = isDark ? "text-slate-400" : "text-slate-400";
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-col gap-2 md:flex-row md:items-center md:gap-3 w-full md:w-auto">
          <div className={inputWrapper}>
            ...
            <input
              type="text"
              placeholder="Buscar por cliente, NUIT, estado..."
              className={input}
            />
          </div>
...
export default RelClientesStatus;
