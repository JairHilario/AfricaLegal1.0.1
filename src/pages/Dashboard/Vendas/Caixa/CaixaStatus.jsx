...
function CaixaStatus({ search, setSearch, onAddMovimento }) {
  ...
  return (
    <>
      <div className="mb-4 rounded-md border border-sky-100 bg-white p-4 md:p-6 shadow-sm">
        ...
        <div className="mt-4 relative">
          ...
          <input
            ...
            placeholder="Buscar por descrição, tipo, valor..."
      ...
      {showAddForm && null /* depois entra o formulário de movimento */}
    </>
  );
}
