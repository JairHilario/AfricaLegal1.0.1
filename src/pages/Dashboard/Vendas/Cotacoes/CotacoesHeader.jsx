...
function CotacoesHeader({ stats = {}, temaAtual = "light" }) {
  const {
    total = 0,
    pendentes = 0,
    aprovadas = 0,
  ...
  return (
    <header className={headerClasses}>
      <h1 className={titleClasses}>Cotações</h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 text-xs">
        ...
        <div className={`${baseTile} ${boxAbertas}`}>
          <h3 className="text-sky-600">Abertas</h3>
          <p className={valueAbertas}>{pendentes}</p>
        </div>

        <div className={`${baseTile} ${boxAprovadas}`}>
          <h3 className="text-emerald-600">Aprovadas</h3>
          <p className={valueAprovadas}>{aprovadas}</p>
        </div>

        <div className={`${baseTile} ${boxRejeitadas}`}>
          <h3 className="text-rose-600">Rejeitadas</h3>
          <p className={valueRejeitadas}>{recusadas}</p>
        </div>

        <div className={`${baseTile} ${boxVencidas}`}>
          <h3 className="text-amber-600">Vencidas</h3>
