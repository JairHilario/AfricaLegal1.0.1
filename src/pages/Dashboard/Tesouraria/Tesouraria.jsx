...
function Tesouraria({ temaAtual = "light" }) {
  ...
  return (
    <div className={containerClasses}>
      ...
      {/* CONTEÚDO */}
      <div className="p-1">
        {activeTab === "contas" && <ContasBancarias temaAtual={temaAtual} />}
        {activeTab === "deposito" && <Deposito temaAtual={temaAtual} />}
        {activeTab === "transferencia" && (
          <Transferencia temaAtual={temaAtual} />
        )}
      </div>
    </div>
  );
